...
class TestLoginFromMainPage:
    ...
    def test_guest_can_go_to_login_page(self, browser, link):
        ...
        login_page.should_be_login_form_on_login_page()
        login_page.should_be_register_form_on_login_page()


@pytest.mark.parametrize('link', ["http://selenium1py.pythonanywhere.com/"])
@pytest.mark.go_to_basket
class TestGoToBasketFromMainPage:
    def test_guest_should_see_basket_button_on_main_page(self, browser, link):
        page = MainPage(browser, link)
        page.open()
